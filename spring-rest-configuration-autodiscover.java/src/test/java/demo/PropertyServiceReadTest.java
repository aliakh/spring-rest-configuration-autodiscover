...
@SpringBootTest
@Transactional
public class PropertyServiceReadTest {
    ...
    @Test
    public void findPropertyByName1Test() {
    ...
    @Test
    public void findPropertyByName2Test() {
    ...
    @Test
    public void findPropertyByName3Test() {
    ...
    @Test
    public void findPropertyByName4Test() {
